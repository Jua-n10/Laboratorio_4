...
public class GUIGuest extends javax.swing.JFrame {
    ...
    private void agregarCarritoVisitanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarCarritoVisitanteActionPerformed
        // TODO add your handling code here:
        List<Object[]> elementosSeleccionados = obtenerElementosSeleccionados(tblProducts);
        ...
        for (Object[] fila : elementosSeleccionados) {
            System.out.println("Seleccionado: " + fila[0] + ", " + fila[1] + ", " + fila[2]);
            
            Product product = productService.findProductById((Long) fila[0]);
